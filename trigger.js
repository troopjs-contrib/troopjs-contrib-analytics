define([
  ...
  "./error"
], function (Component, AnalyticsError) {
  "use strict";
  ...
  return Component.extend(
    function ($element, name, triggers) {
      var me = this;
      var _triggers;
      ...
      switch (OBJECT_TOSTRING.call(triggers)) {
        ...
        default:
          throw new AnalyticsError("'triggers' is of unsupported type");
      }
      ...
      me.on("sig/initialize", function () {
        _triggers.forEach(function (_trigger) {
          ...
          switch (OBJECT_TOSTRING.call(_trigger)) {
            ...
            default:
              throw new AnalyticsError("'_trigger' is of unsupported type");
          }
